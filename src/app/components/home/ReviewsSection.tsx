  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "Wire Fitness — это лучший фитнес-клуб, в котором я была. Современное оборудование, профессиональные тренеры и невероятная атмосфера. За полгода тренировок достигла всех своих целей!",
    ...
    },
    {
      ...
      rating: 5,
      text: "Занимаюсь с персональным тренером уже 4 года. За это время полностью изменил своё тело и образ жизни. Wire Fitness — это не просто клуб, это образ жизни!",
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Более 5000 человек уже изменили свою жизнь с Wire Fitness
          </p>
        </div>
